...
class LoginUI(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.userAvatar.set_dayu_image(QPixmap("D:/ToolBox_Project/library/LibIcon/male.svg"))
        ...
        self.passwordLabel.set_dayu_image(QPixmap("D:/ToolBox_Project/library/LibIcon/edit_fill.svg"))
